          ...
          <td colspan="2">
            ...
            <div style="text-align:center;padding:20px;margin-top:25px;">
              ...
              <p style="margin-top:40px;margin-bottom: 40px;">
                We look forward to seeing you at the sixth edition of <strong>RE+ MEXICO from April 14 to 16, Expo Guadalajara, Jalisco.</strong>
              </p>
              <div style="background: #4E549F;color:white;width:fit-content;border-radius: 20px;padding:20px;margin:auto;position:relative;">
               ...
               <p> Tuesday 14 and Wednesday  15 from 11:00 am - 6:00 pm</p>
               <p>Thursday 16 from 11:00 am - 5:00 pm hrs</p>
              </div>
            </div>               
