                            ...
                            <div className="rounded-2xl bg-gradient-to-br from-slate-50 to-slate-100/50 border border-slate-200 p-4 sm:p-5">
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="text-sm font-bold text-slate-900 capitalize">{formatDate(activeDay.date)}</div>
                                            <div className="text-xs text-slate-500 mt-0.5">Día seleccionado</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="pl-3 sm:pl-4 md:pl-6 flex flex-col md:flex-row gap-4 md:gap-5">
                                        ...
                                        <div className="flex flex-row md:flex-col justify-start items-start gap-2 text-xs text-slate-600 md:min-w-[180px] md:max-w-[180px]">
                                            <span className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full border border-slate-200 bg-slate-50 px-2.5 sm:px-3 py-1 font-semibold text-slate-800 shadow-sm text-xs sm:text-sm">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-[#565078] flex-shrink-0"><path fillRule="evenodd" d="M6 3a1 1 0 011-1h1a1 1 0 010 2v1h4V4a1 1 0 112 0v1h1a2 2 0 012 2v7a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h1V4a1 1 0 011-1zm-1 6v5a1 1 0 001 1h8a1 1 0 001-1V9H5zm3 1a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z" clipRule="evenodd" /></svg>
