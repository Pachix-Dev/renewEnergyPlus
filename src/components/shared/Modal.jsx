const Modal = ({ isOpen, onClose, speaker, language }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-60">
      <div className="bg-gradient-to-t from-white to-gray-100 p-8 rounded-3xl shadow-xl w-full md:w-5/6 lg:w-3/4 transition-transform transform scale-95 hover:scale-100">
        <div className="flex justify-end mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-8">
            <img
              ...
              alt={speaker.name}
              className="object-cover h-full w-[250px] md:w-[350px] rounded-xl shadow-md mx-auto"
            />
           
    {speaker.nameem === ""
              ? 
                ''
              :  <div className="absolute bottom-0 left-0 bg-blue-500 text-white text-center font-semibold px-4 py-2 rounded-tr-xl">
      {speaker.nameem}
    </div>
